    ...
    data.data.MediaContainer.Metadata.forEach((item, index) => {
        ...
        if (index == itemCount - 1) {
            ...
            app.selectedLibraryStats = {
                ...
                topGenreCount: genreCounts.length ? genreCounts[0].toLocaleString() : "",
                totalGenreCount: genreCounts.length ? Object.keys(genres).length.toLocaleString() : "",
                genreList: genreList,
                ...
                topCountryCount: countryCounts.length ? countryCounts[0].toLocaleString() : "",
                totalCountryCount: countryCounts.length ? Object.keys(countries).length.toLocaleString() : "",
                ...
                topResolution: sortedResolutions.length ? resolutionList[0].toUpperCase() : "",
                ...
                topStudioCount: studioCounts.length ? studioCounts[0].toLocaleString() : "",
                ...
                topActor: actors.length ? actors[0][0] : "",
                topActorCount: actors.length ? actors[0][1].toLocaleString() : "",
                ...
                topContentRatingCount: contentRatingCounts.length ? contentRatingCounts[0].toLocaleString() : 0,
                totalContentRatingCount: contentRatingCounts.length ? Object.keys(contentRatings).length.toLocaleString() : 0,
